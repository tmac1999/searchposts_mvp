...
import com.mrz.searchposts.component.feedback.FeedBackContract;
 ...
 */
public class SendPostPresenter implements FeedBackContract.Presenter {
    private FeedBackActivity feedBackActivity;

    public SendPostPresenter(SPRepository spRepository, FeedBackActivity feedBackActivity) {
